...
<body>
    ...
    ?>
    <div class="container">
        <a href="#" class="brand-logo" style="font-size: 15px;">Agendar Recurso</a>
            ...
            <div class="col s12 m6">
                <div class="card">
                    <div class="card-content">
                        ...
                        <a class="btn waves-effect waves-light button-color" name="agendar" href="/mobile/home/agendando_recurso.php?recId=' . $row['recId'] . "&resname=" . $row['nome'] . '">
                            AGENDAR<i class="material-icons right">schedule</i>
                        </a>
                    </div>
                </div>
            </div>';
