...
<body>
    ...
    ?>
    <div class="container">
        <a href="#" class="brand-logo" style="font-size: 15px;">Gerenciar Recurso</a>
            ...
            while ($row = mysqli_fetch_array($result)) {
                if($row['quantidade'] == '0') {
                    ...
                    <div class="col s12 m6">
                        <div class="card desabilitado white-text">
                            <div class="card-content">
                                <center><div>Este recurso está <b>desabilitado</b></div></center>
                                <h5>' . $row['nome'] . '<br><span style="font-size: 12px;">' . $row['tipo_recurso'] . '</span></h5>
                                <p>' . $row['descricao'] . '</p><br>
                                <a class="btn waves-effect waves-light desabilitado" name="agendar" href="/mobile/home/editarRecurso.php?recId=' . $row['recId'] . '">
                    ...
                    <div class="col s12 m6">
                        <div class="card">
                            <div class="card-content">
                                <h5>' . $row['nome'] . '<br><span style="font-size: 12px;">' . $row['tipo_recurso'] . '</span></h5>
                                <p>' . $row['descricao'] . '</p><br>
                                <a class="btn waves-effect waves-light white black-text" name="agendar" href="/mobile/home/editarRecurso.php?recId=' . $row['recId'] . '">
                                    EDITAR<i class="material-icons right">edit</i>
                                </a>
                            </div>
                        </div>
