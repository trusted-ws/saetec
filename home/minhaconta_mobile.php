...
<body>
  ...
  <ul class="h-menu">
    ...
    <li><a href="minhaconta_mobile.php"><span class="mif-user icon"></span> Minha Conta</a></li>
    <?php
        ...
        <table>
          ...
          <tr>
            ...
            <td><?php echo $dados['nome']; ?>
              <form action="minhaconta_mobile.php" method="POST">
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
          if (isset($_POST['alterar_senha'])) {
            if ($_POST['alterar_senha'] == 1) {
              echo '<br><br><hr>
                <form action="minhaconta_mobile.php" method="POST" data-role="validator">
                ...
                <a href="minhaconta_mobile.php" class="button secondary default rounded">Cancelar</a>
                </form>
